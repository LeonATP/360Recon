...
def main(opts):
    ...
    #!For Equirectangular images,we don't load weights from checkpoint
...
if __name__ == '__main__':
    ...
    sys.argv=['train.py', '--name','without_image_Encoder', '--log_dir', 'logs', '--config_file', 'configs/models/pano_model.yaml', '--data_config', 'configs/data/matterport3d_default_train.yaml',
     '--batch_size', '4']
    '''
    sys.argv=['train.py', '--config_file', 'configs/models/pano_model.yaml', '--data_config', 'configs/data/matterport3d_default_train.yaml','--load_weights_from_checkpoint', '/home/yzm/Workspace/simplerecon_v2/logs/Sphere_CNN/version_0/checkpoints/epoch=28-step=49607.ckpt','--batch_size', '4']
    '''

...
def process_all_folders(txt_file_path, output_file_path):
    ...
    with open(output_file_path, 'w') as output_file:
        ...
        for folder_path in folder_paths:
            folder_path = os.path.join("/home/yzm/dataset/S2D3D/", folder_path)
...
output_file_path = 'data_splits/S2D3D/test_three_view_deepvmvs.txt'  # Replace with your desired output file path

...
class Matterport3dDataset(GenericMVSDataset):
    """ 
        ...
        if os.path.exists(valid_frame_path):
            ...
            for frame_id in range(color_file_count):
                ...
                color_filename = os.path.join(sensor_data_dir, 
                                            f"frame-{frame_id:06d}.color.png")
                depth_filename = color_filename.replace(f"color.png", 
                                                        f"depth.png")
    ...
    def get_gt_mesh_path(dataset_path, split, scan_id):
        ...
        gt_path = os.path.join(
                        dataset_path,
                        Matterport3dDataset.get_sub_folder_dir(split),
                        scan_id,

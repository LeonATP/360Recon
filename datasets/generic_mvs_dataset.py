...
class GenericMVSDataset(Dataset):
    ...
    def __init__(self,
                ...
                high_res_image_width=512,
                high_res_image_height=1024,
                image_depth_ratio=2,
        ...
        if scan_folder is None:
           self.scenes_path = self.dataset_path
        else:
    ...
    def get_frame(self, scan_id, frame_id, load_depth, flip=False):
        ...
        '''
        pred_depth = self.load_pred_depth(scan_id, frame_id)
        output_dict.update({"pred_depth_b1hw": pred_depth})
        '''
        # load intrinsics

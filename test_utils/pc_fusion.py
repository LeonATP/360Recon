...
if __name__ == '__main__':
    ...
    sys.argv=['pc_fusion.py', '--name','PANO_MODEL', '--output_base_path', './output/matterport3d/v17', '--config_file', 'configs/models/pano_model.yaml', '--load_weights_from_checkpoint', '/home/yzm/Workspace/simplerecon_v2/logs/PANO_MODEL/version_122/checkpoints/epoch=17-step=133344.ckpt', '--data_config', 'configs/data/metterport3d_default_test.yaml',

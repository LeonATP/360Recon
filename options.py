...
class Options():
    ...
    lr_steps: list = dataclasses.field(default_factory=lambda: [540])
    ...
    viz_render_width: int = 1024
    viz_render_height: int = 512
